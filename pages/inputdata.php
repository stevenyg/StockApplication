                                ...
                                <div class="col-lg-12">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Nama Barang" name="namabarang" autofocus>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Merek</label>
                                            <input class="form-control" placeholder="Merek" name="merek">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Harga Beli" type="number" name="hargabeli">
                                        </div>
